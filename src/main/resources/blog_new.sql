/*
 ...
 Source Server         : 192.168.56.101_3306
...
CREATE TABLE `b_article`  (
  ...
  `is_publish` int(10) NULL DEFAULT 0 COMMENT '是否发布 0：下架 1:预发布 2：发布',
...
-- ----------------------------
-- Table structure for b_cancellation_request
-- ----------------------------
DROP TABLE IF EXISTS `b_cancellation_request`;
CREATE TABLE `b_cancellation_request`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NULL DEFAULT NULL,
  `username` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `email` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL,
  `create_time` datetime(1) NULL DEFAULT NULL,
  `reason_text` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of b_cancellation_request
-- ----------------------------
...
CREATE TABLE `b_feed_back`  (
  ...
  `type` int(1) NOT NULL COMMENT '反馈类型 0:需求 1：缺陷',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = InnoDB AUTO_INCREMENT = 1 CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = DYNAMIC;
...
-- ----------------------------
-- Table structure for b_handled_cacellation
-- ----------------------------
DROP TABLE IF EXISTS `b_handled_cacellation`;
CREATE TABLE `b_handled_cacellation`  (
  `id` int(10) NOT NULL,
  `cancellation_id` int(10) NULL DEFAULT NULL,
  `user_id` int(10) NULL DEFAULT NULL,
...
-- ----------------------------
-- Records of b_handled_cacellation
-- ----------------------------
...
-- ----------------------------
-- Table structure for b_mod_pack
-- ----------------------------
...
-- ----------------------------
-- Table structure for b_related_link
-- ----------------------------
DROP TABLE IF EXISTS `b_related_link`;
CREATE TABLE `b_related_link`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `mod_pack_id` int(10) NULL DEFAULT NULL,
...
CREATE TABLE `b_tags`  (
  ...
  `click_volume` int(10) NULL DEFAULT 0 COMMENT '点击量',
  `sort` int(11) NOT NULL COMMENT '排序',
  `create_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '创建时间',
  `update_time` datetime(0) NULL DEFAULT CURRENT_TIMESTAMP(0) COMMENT '最后更新时间',
  PRIMARY KEY (`id`) USING BTREE,
...
-- Records of b_user
-- ----------------------------
INSERT INTO `b_user` VALUES (7, 'admin', '25d55ad283aa400af464c76d713c07ad', '2021-09-27 15:43:45', '2023-01-30 15:27:45', 1, 1, 1, 1, '58.20.50.139', '中国-湖南省-长沙市', 'Windows 10', '2023-01-30 15:35:07', 'Chrome 10');
...
-- ----------------------------
-- Table structure for b_user_mod_pack
-- ----------------------------
DROP TABLE IF EXISTS `b_user_mod_pack`;
CREATE TABLE `b_user_mod_pack`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `user_id` int(10) NULL DEFAULT NULL,
  `mod_pack_id` int(10) NULL DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
